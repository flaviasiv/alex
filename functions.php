...
// fonte 
function meu_tema_adiciona_estilos() {
    wp_enqueue_style('fonte-personalizada', get_template_directory_uri() . '/style.css');
}
add_action('wp_enqueue_scripts', 'meu_tema_adiciona_estilos');
